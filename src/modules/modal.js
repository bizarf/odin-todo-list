import { addTask, addProject } from "./todos";
...
const projectModal = (() => {
    ...
    const _projectFormClosing = () => {
        ...
        modalSharedCoding.formCancelButton(
            "#projectCancelButton",
            ".projectModal"
        );
    };
        ...
        addProjectButton.onclick = (e) => {
            ...
            if (projectForm.reportValidity() === false) {
                ...
                for (let item of projectStorage.projects) {
                    if (
                        projectTitle.value.toLowerCase() ===
        ...
        button.addEventListener("click", (e) => {
            ...
            if (form.reportValidity() === false) {
                ...
                if (dueDate.value === "") {
                    ...
                    taskStorage.tasks[dataId.value].description =
                        description.value;
                    taskStorage.tasks[dataId.value].dueDate = dueDate.value;
                    taskStorage.tasks[dataId.value].priority = priority.value;
                    taskStorage.tasks[dataId.value].projectTitle =
                        project.value;
                } else {
                    taskStorage.tasks[dataId.value].title = title.value;
                    taskStorage.tasks[dataId.value].description =
                        description.value;
                    taskStorage.tasks[dataId.value].dueDate = format(
...
export { taskModal, projectModal, taskInfoModal, editTaskModal };
